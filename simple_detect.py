...
def detect():
    ...
    img_size = [512, 512]
    weights = '/home/daniele/work/workspace_python/yolov5/runs/exp6/weights/best.pt'
    inference_model = InferenceModel(img_size, weights, half=False)

    cap = cv2.VideoCapture(-1)

    # colors = [(255, 100, 000), (0, 255, 100)]
    # while True:
    #     ret, image = cap.read()  # cv2.imread('/media/daniele/Data/datasets/marchesini/scan_0/obj_006/20200725133041588600_45791657-ce6a-11ea-8df7-00d861df1197/00000.jpg')
    #     if ret:
